...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>asset/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css" type="text/css">
  <!-- Argon CSS -->
  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="index.php">
        <img src="<?= base_url(); ?>asset/assets/img/11.png">
      </a>
        ...
        <div class="navbar-collapse-header">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="index.php">
                <img src="<?= base_url(); ?>asset/assets/img/brand/blue.png">
              </a>
            </div>
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            <div class="card-header bg-transparent pb-5">
              ...
              <div class="text-center">
                ...
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="<?= base_url(); ?>asset/assets/img/icons/common/google.svg"></span>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="post" action="aksiRegister.php">
